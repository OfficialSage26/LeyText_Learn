...
export default function TranslatePage() {
  ...
  }, [mounted, sourceLanguage, targetLanguage, setTargetLanguage]);
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                >
                  ...
                  <SelectContent>
                    {SUPPORTED_LANGUAGES.map(lang => (
                      <SelectItem key={`source-${lang}`} value={lang} disabled={lang === targetLanguage}>
                        {lang}
                      </SelectItem>
                    ))}
                  </SelectContent>
              ...
              <div className="flex-1 w-full">
                ...
                >
                  ...
                  <SelectContent>
                    {SUPPORTED_LANGUAGES.map(lang => (
                      <SelectItem key={`target-${lang}`} value={lang} disabled={lang === sourceLanguage}>
                        {lang}
                      </SelectItem>
                    ))}
                  </SelectContent>
